<template>
  <div class="container">
    ...
    <label @click="goFormOrder">{{ productData.title }}( Ø30 СМ - {{productData.minPrice}}₴ / Ø40 СМ - {{productData.maxPrice}}₴)</label>
      
    </div>
    <div v-else>
    <label @click="goFormOrder">{{ productData.title }}</label>
