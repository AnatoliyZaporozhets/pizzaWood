<template>
  <div>
    ...
    <div>
        <div>
          <input type="radio" name="typeObg" :value="choice(pizza)">
          <label>Pizza</label>
        </div>
        <div>
          <input type="radio" name="typeObg" :value="choice(burger)">
          <label>Burger</label>
        </div>
        <div>
          <input type="radio" name="typeObg" :value="choice(drink)">
          <label>Drink</label>
        </div>
        <div>
          <input type="radio" name="typeObg" :value="choice(set)">
          <label>Set</label>
        </div>
    </div>
    <!-- <div>
