  ...
  <div class="container">
    <main-master-page>
      <template v-slot:main>
        ...
        <div v-else>
          ...
          <table>
            ...
            <tr v-for="prod in carts" :key="prod.id">
              ...
              <td>₴{{prod.price*prod.count}}.00</td>
              <td>
        ...
        <div class="totalSumDiv">
          <label class="totalSumLabel">Загальна сума замовлення: ₴{{total}}.00</label>
          <button class="totalSumBtn">ОФОРМИТИ ЗАМОВЛЕННЯ</button>
        </div>
        </div>
        </div>
        <div><button @click="local">goHome</button></div>
      </template>
    </main-master-page>
  </div>
</template>
