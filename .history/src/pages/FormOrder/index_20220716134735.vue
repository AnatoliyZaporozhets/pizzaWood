...
export default {
  ...
  methods: {
    ...mapActions( "ingredient",["loadIngredients"],
      "userChooseProd",["addIngredientToSearch",'getProductById','changePriceUserProd','changeCountUserProd'],
      "cart",["addIngredientToCartList"],
      // "product",["addIngredientToCartList"],
      // ['addIngredientToSearch',"getProductById", 
      // "deleteProduct",'loadIngredients','changePriceUserProd',
      // 'changeCountUserProd','addIngredientToCartList']
      ),
