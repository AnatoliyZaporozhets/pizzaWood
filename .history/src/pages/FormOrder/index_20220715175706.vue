  ...
  <div class="container">
    <main-master-page>
      <template v-slot:main>
        ...
        <div v-if="$route.params.prodName = searchProduct.prodName && (searchProduct.prodName === 'pizza' || searchProduct.prodName === 'burger')">
          <table>
...
export default {
  ...
  methods: {
    ...mapActions(['addIngredientToSearch',"getProductById", "deleteProduct",'loadIngredients','changePriceUserProd','changeCountUserProd']),
