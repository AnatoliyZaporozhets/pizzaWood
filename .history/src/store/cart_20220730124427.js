...
const cart = ({
  ...
  mutations: {
    ...
    addIngredientToCart(state, product) {
      ...
      console.log(typeof(JSON.parse(localStorage.getItem('cartData'))) !== Array);
      console.log('Obj or Arr');
      console.log(typeof(JSON.parse(localStorage.getItem('cartData'))) !== Array ? [] : JSON.parse(localStorage.getItem('cartData')));
