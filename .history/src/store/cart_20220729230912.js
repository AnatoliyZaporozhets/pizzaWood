...
const cart = ({
  namespaced: true,  
  state: {
    cart: JSON.parse(localStorage.getItem('cartData')).typeof !== Array ? [] : JSON.parse(localStorage.getItem('cartData')),
    total:0,
  ...
  mutations: {
    ...
    addIngredientToCart(state, product) {
      console.log(JSON.parse(localStorage.getItem('cartData')).typeof);
