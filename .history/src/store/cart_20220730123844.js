...
const cart = ({
  namespaced: true,  
  state: {
    cart: typeof(JSON.parse(localStorage.getItem('cartData'))) === Object ? [] : JSON.parse(localStorage.getItem('cartData')),
    total:0,
  ...
  mutations: {
    ...
    addIngredientToCart(state, product) {
      ...
      console.log(typeof(JSON.parse(localStorage.getItem('cartData'))));
      console.log('typeof === Object');
      console.log(typeof(JSON.parse(localStorage.getItem('cartData'))) === Object);
      console.log('Obj or Arr');
      console.log(typeof(JSON.parse(localStorage.getItem('cartData'))) === Object ? [] : JSON.parse(localStorage.getItem('cartData')));
